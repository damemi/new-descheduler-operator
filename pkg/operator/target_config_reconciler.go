...
func (c TargetConfigReconciler) sync() error {
	descheduler, err := c.operatorClient.KubeDeschedulers("openshift-descheduler-operator").Get("cluster", metav1.GetOptions{})
	if err != nil {
		return err
	}
		...
		cm := &v1.ConfigMap{
			...
			ObjectMeta: metav1.ObjectMeta{
				...
				OwnerReferences: []metav1.OwnerReference{
					{
						APIVersion: descheduler.APIVersion,
						Kind:       descheduler.Kind,
						Name:       descheduler.Name,
						UID:        descheduler.UID,
					},
				},
