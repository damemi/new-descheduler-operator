...
var kubedeschedulersResource = schema.GroupVersionResource{Group: "kubedeschedulers.operator.openshift.io", Version: "v1beta1", Resource: "kubedeschedulers"}

var kubedeschedulersKind = schema.GroupVersionKind{Group: "kubedeschedulers.operator.openshift.io", Version: "v1beta1", Kind: "KubeDescheduler"}

// Get takes name of the kubeDescheduler, and returns the corresponding kubeDescheduler object, and an error if there is any.
func (c *FakeKubeDeschedulers) Get(name string, options v1.GetOptions) (result *v1beta1.KubeDescheduler, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeDeschedulers) List(opts v1.ListOptions) (result *v1beta1.KubeDeschedulerList, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeDeschedulers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeKubeDeschedulers) Create(kubeDescheduler *v1beta1.KubeDescheduler) (result *v1beta1.KubeDescheduler, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeDeschedulers) Update(kubeDescheduler *v1beta1.KubeDescheduler) (result *v1beta1.KubeDescheduler, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeDeschedulers) UpdateStatus(kubeDescheduler *v1beta1.KubeDescheduler) (*v1beta1.KubeDescheduler, error) {
	obj, err := c.Fake.
...
func (c *FakeKubeDeschedulers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeKubeDeschedulers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(kubedeschedulersResource, c.ns, listOptions)
...
func (c *FakeKubeDeschedulers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.KubeDescheduler, err error) {
	obj, err := c.Fake.
